...
@section('user_content')
            ...
            <div class="invoice_items">
                <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <th>{{ $invoice->receipts()->sum('amount') }}</th>
                      <th></th>
                  </tr>
                </table>
            </div>
  ...
  {{-- Modal For add new Receipt for invoice--}}
	...
	<!-- Modal -->
	<div class="modal fade" id="newReceiptForinvoice" tabindex="-1" role="dialog" aria-labelledby="newReceiptForinvoice" aria-hidden="true">
		<div class="modal-dialog" role="document">
			{!! Form::open([ 'route' => [ 'user.receipts.store', [$user->id, $invoice->id] ], 'method' => 'post' ]) !!}
		  <div class="modal-content">
			<div class="modal-header">
			  <h5 class="modal-title" id="newReceiptForinvoice"> New Receipts For This Invoice </h5>
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
